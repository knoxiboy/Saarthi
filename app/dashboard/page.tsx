        ...
        const fetchMetrics = async () => {
            try {
                ...
                if (data && data.metrics) {
                    setMetrics({
                        resumeScore: data.insights?.atsScore || 0,
                        roadmapsGenerated: data.metrics.roadmapsGenerated || 0,
                        jobReadinessScore: data.insights?.jobReadinessScore || 0,
                        docsGenerated: data.metrics.docsGenerated || 0
                    });
                }
            } catch (error) {
