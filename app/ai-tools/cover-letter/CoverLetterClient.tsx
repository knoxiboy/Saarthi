                ...
                <div className="space-y-2">
                    ...
                    <div className="flex flex-col">
                        ...
                        <h1 className="text-4xl font-black text-white uppercase tracking-tighter">
                            Cover Letter <span className="text-transparent bg-clip-text bg-linear-to-r from-blue-400 to-purple-500">Architect</span>
                        </h1>
                    </div>
                </div>
                        ...
                        <div className="space-y-8">
                            <div className="bg-white/5 border border-white/10 rounded-[2.5rem] p-10 backdrop-blur-2xl space-y-8">
                                ...
                                <button
                                    ...
                                    disabled={loading}
                                    className="w-full py-6 bg-linear-to-r from-blue-600 to-purple-600 text-white rounded-2xl font-black text-xs uppercase tracking-[0.25em] flex items-center justify-center gap-3 hover:scale-[1.02] active:scale-[0.98] transition-all shadow-[0_20px_40px_rgba(37,99,235,0.2)] group"
                                >
                                    {loading ? (
                    ...
                    >
                        {fetchingHistory ? (
                            Array(4).fill(0).map((_, i) => (
                                <div key={i} className="h-48 bg-white/5 animate-pulse rounded-4xl" />
                            ))
                        ) : history.length > 0 ? (
                            history.map((item) => (
                                <div
                                    ...
                                    className="group bg-white/5 border border-white/5 hover:bg-white/8 hover:border-white/10 rounded-4xl p-8 transition-all duration-500 cursor-pointer relative overflow-hidden"
                                >
