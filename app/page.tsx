        ...
        <section className="px-6 pb-20 relative z-10">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-400 max-w-2xl mx-auto mb-12 leading-relaxed">
              Saarthi is your personal AI career wingman. From resume analysis to custom learning roadmaps, we provide the tools you need to level up your professional life.
            </p>
      ...
      <footer className="border-t border-white/5 bg-slate-950/50 py-5">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6 text-slate-500">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-gradient-to-br from-blue-600 to-purple-600 rounded-lg flex items-center justify-center text-white font-bold text-sm">S</div>
            <span className="font-bold text-white">Saarthi</span>
          </div>
          <p className="text-sm">© 2026 Saarthi. Engineered for Excellence.</p>
